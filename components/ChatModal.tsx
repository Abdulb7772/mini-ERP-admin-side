                  ...
                  <div className="flex gap-2 items-center">
                    <div className="relative">
                      <button
                        ...
                        className="h-10 w-10 flex items-center justify-center text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-lg transition-colors"
                    ...
                    <button
                      ...
                      className="h-10 flex items-center justify-center bg-linear-to-r from-blue-600 to-purple-600 text-white rounded-lg px-4 hover:from-blue-700 hover:to-purple-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all duration-200 font-bold shadow-lg hover:shadow-xl hover:scale-105 text-sm sm:text-base shrink-0"
                    >
